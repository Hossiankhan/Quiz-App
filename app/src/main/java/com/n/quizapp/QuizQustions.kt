...
class QuizQustions : AppCompatActivity() {
    ...
    private val alternativesIds = arrayOf(R.id.option1, R.id.option2, R.id.option3, R.id.option4)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvProgress = findViewById(R.id.pronum)
        ...
        btnSubmit?.setOnClickListener {
            if (!isAnswerChecked) {
                ...
                if (currentQuestionIndex < questionsList.size - 1) {
                    ...
                    val intent = Intent(this, com.n.quizapp.Result::class.java)
